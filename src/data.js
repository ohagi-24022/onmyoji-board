...
export const SHIKIGAMI_MASTER = [
  ...
  { id: "z_kamaitachi", name: "鎌鼬", element: "金", hp: 2, atk: 3, reach: 2, move: 2, cost: 2, isTensho: false, desc: "高機動の奇襲" },
  { id: "z_tengu", name: "烏天狗", element: "木", hp: 6, atk: 3, reach: 1, move: 2, cost: 3, isTensho: false, desc: "高機動の遊撃手" },
  { id: "z_jorogumo", name: "絡新婦", element: "水", hp: 6, atk: 0, reach: 3, move: 1, cost: 3, isTensho: false, statusEffect: "bind", desc: "術命中で拘束" },
  ...
  { id: "s_tenko", name: "天后", element: "水", hp: 8, atk: 2, reach: 3, move: 1, cost: 6, isTensho: true, tenshoAbility: "knockback", ougi: "幻惑の乗っ取り", desc: "憑依:術命中で後退" },
  ...
  { id: "s_sujaku", name: "朱雀", element: "火", hp: 10, atk: 5, reach: 2, move: 1, cost: 7, isTensho: true, tenshoAbility: "balance", ougi: "煉獄の業火", desc: "憑依:攻+2/HP+5" },
